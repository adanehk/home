...
public class Ventana extends javax.swing.JFrame {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        ...
                                        .addComponent(sliderFiltro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(genero, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void aplicarFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aplicarFiltroActionPerformed
        Filtro filtro = new Filtro(this,true);
        DefaultListModel<Peli> modelo2 = new DefaultListModel<>();
        Filtro.listaFiltro.setModel(modelo2);
        for(int i =0;i<pelis.size();i++){
            if(pelis.get(i).getTitulo().contains(Ventana.nombreFiltro.getText())||pelis.get(i).getGenero().contains(Ventana.genero.getText())|| (sliderFiltro.getValue() > pelis.get(i).getNota())){
                
                modelo2.addElement(Peliculas.pelis.get(i));
    ...
    static javax.swing.JTextField genero;
    ...
    static javax.swing.JTextField nombreFiltro;
    private javax.swing.JButton nuevaPeli;
    static javax.swing.JSlider sliderFiltro;
